...
function play() {
    ...
    agentBehavior = new Behavior("randomAssumptionBehavior", getBlueState(), getRedState());
...
function redMove(to) {
    ...
    if(validMove) {
        ...
        if(cheackIfLoss()) {
            win = false;
            score += crushing;
            alert("Game ended! \nYou collided with the blue ball. Your score is: "+score);
            finishGame();
        }
        if(getRedState() == "a6") {
            win = true;
            ...
            alert("Well done, you reached your destination safely!\n"+
                "Your score is: "+score+ " with: "+redCounterSteps+" steps.");
            finishGame();
        }
    }
}
